...
# Gestor de geometr?a (grid). Ventana dimensionable
...
class Aplicacion():
    def __init__(self):
        ...
        # adapten al contenedor, si se amplia o reduce el tama?o
        # de la ventana, es necesario definir la opci?n 'sticky'.
        # Cuando un widget se ubica en el grid se coloca en el
        # centro de su celda o cuadro. Con 'sticky' se
        # establece el comportamiendo 'pegajoso' que tendr? el 
        # widget dentro de su celda, cuando se modifique la 
        # dimensi?n de la ventana. Para ello, se utilizan para
        # expresar sus valores los puntos cardinales: N (Norte),
        # S (Sur), (E) Este y (W) Oeste, que incluso se pueden
        # utilizar de forma combinada. El widget se quedar? 
        # 'pegado' a los lados de su celda en las direcciones
        # que se indiquen. cuando la ventana cambie de tama?o. 
        # Pero con definir la opci?n 'sticky' no es suficiente: 
        # hay activar esta propiedad m?s adelante.
        ...
        # A continuaci?n, se activa la propiedad de expandirse
        # o contraerse definida antes con la opci?n
        # 'sticky' del m?todo grid().
        # La activaci?n se hace por contenedores y por filas
        # y columnas asignando un peso a la opci?n 'weight'.
        # Esta opci?n asigna un peso (relativo) que se utiliza
        # para distribuir el espacio adicional entre columnas
        # y/o filas. Cuando se expanda la ventana, una columna
        # o fila con un peso 2 crecer? dos veces m?s r?pido
        # que una columna (o fila) con peso 1. El valor
        # predeterminado es 0 que significa que la columna o
        # o fila no crecer? nada en absoluto. 
